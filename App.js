...
class Message extends Component {
  constructor(props) {
    ...
    this.state = {
      messages: [
        createImageMessage('https://www.computersciencedegreehub.com/wp-content/uploads/2020/06/What-is-a-Systems-Administrator-1024x576.jpg'),
        createTextMessage('This is one member of Team TechDiggers'),
        createTextMessage('Welcome for testing!'),
